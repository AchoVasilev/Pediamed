...
INSERT INTO cabinets(id, name, city, address, post_code, mobile_phone, deleted, date_created)
VALUES (1, 'Габрово', 'гр. Габрово', 'Медицински център Хипократ, площад Белорусия 2', '5300', '123456789', false, (now() at time zone 'utc')),
        (2, 'Плевен', 'гр. Плевен', 'ул. Стефан Караджа 49', '5800', '123456789', false, (now() at time zone 'utc'));
