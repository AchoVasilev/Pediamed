...
INSERT INTO specialization (name, description, doctor_id)
VALUES ('Неонатология', 'Подспециалност на детските болести, която се занимава с медицински грижи за новородените, по-специално болните или недоносените.', '83f00c4a-3e7a-4f74-b8d7-04705dad0ba2'),
       ('Детски болести', 'Дял от медицината, който се занимава с проследяване на физическото и нервно-психическото развитие на детския организъм, диагностика и лечения на детски заболявания.', '83f00c4a-3e7a-4f74-b8d7-04705dad0ba2')
...
INSERT INTO cabinets(id, name, city, address, post_code, mobile_phone, doctor_id, deleted, date_created)
