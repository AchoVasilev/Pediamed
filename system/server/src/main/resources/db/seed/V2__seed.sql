...
VALUES ('e02fe4eb-a24b-4588-a48c-197bd00138a7', 'pediamedbg@gmail.com', 'ASDASD', 'Павлина', 'Петрова', 'Михова', '0878787342');
...
INSERT INTO cabinets(id, name, city, address, post_code, phone_number, doctor_id, deleted, date_created)
VALUES (1, 'Габрово', 'гр. Габрово', 'Медицински център Хипократ, площад Белорусия 2', '5300', '0878787342', '83f00c4a-3e7a-4f74-b8d7-04705dad0ba2', false, (now() at time zone 'utc')),
        (2, 'Плевен', 'гр. Плевен', 'ул. Стефан Караджа 49', '5800', '0878787342', '83f00c4a-3e7a-4f74-b8d7-04705dad0ba2', false, (now() at time zone 'utc'));
